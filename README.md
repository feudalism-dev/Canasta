...
1. Put `lsl/Canasta_Table.lsl`, `lsl/Canasta_Http.lsl`, and `lsl/Canasta_Display.lsl` on the game table root (with AVsitter; seats 0–3). Compile Table + HUD with your **Experience**.
